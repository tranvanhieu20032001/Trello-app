...
const ConfirmAction = ({ isOpen, onClose, onConfirm, title, message, position = "top-0 right-0" }) => {
  ...
  return (
    <div className={`absolute ${position} z-20  flex items-center justify-center`}>
      ...
      >
        ...
        <p className="mt-2 text-sm font-normal" dangerouslySetInnerHTML={{ __html: message }} />
